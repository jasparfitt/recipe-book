...
## Build
The app will build on every commit to main, but if you need to build it manually run the [Github action](https://github.com/jasparfitt/recipe-book/actions/workflows/mobileApp.yml). Or you can build locally with `eas build --non-interactive`.
